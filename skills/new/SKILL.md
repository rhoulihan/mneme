...
3. Run `mneme new <name> --description "<scope statement>" --owner "<owner>" --sensitivity <s>` (binary at `"$CLAUDE_PLUGIN_ROOT/bin/mneme"` when installed, else `bin/mneme`).
